        ...
        <>
            <div className="flex flex-wrap">
                ...
                <div className="w-full md:w-1/3 px-10">
                    ...
                    <div className="mt-2">
                        <a href="" className="block mb-2 text-[#808191]">Terms of Use</a>
                        <a href="" className="block mb-2 text-[#808191]">Community Guidelines</a>
                        <a href="" className="block mb-2 text-[#808191]">How it Works</a>
                        <a href="" className="block mb-2 text-[#808191]">Evaluating Campaigns</a>
                        <a href="" className="block mb-2 text-[#808191]">Help Center</a>
                        <a href="" className="block mb-2 text-[#808191]">Contact Us</a>
                    </div>
                </div>
            </div>
            ...
            <div className="mt-14 px-4 sm:px-6 lg:px-32">
                ...
                <p className="text-justify pb-2">Providing a trusted platform is a two-way street. We expect everyone to comply with our <a href="" className="text-[#808191]">Terms of Use</a> and keep the lines of communication open and honest. Not doing so may jeopardize the confidence and trust of the community who is excited to see entrepreneurial projects succeed.</p>
            </div>
            ...
            <div className="flex flex-wrap ">
                ...
                <div className="w-full md:w-1/2 px-10">
                    ...
                    <p className="mt-1 text-justify">Give backers peace of mind and confidence in backing your project by including detailed information about your team, qualifications, and track record. Be open about the risks and challenges. The more information you provide upfront, the more potential backers will understand that you're trustworthy and committed to seeing your project through. <a href="" className="text-[#808191]">Fill out your profile.</a></p>
                    <h3 className="text-xl font-semibold mt-4 text-[#808191]">Engage backers</h3>
                    <p className="mt-1 text-justify">Keep everyone informed of your progress or setbacks through commenting, direct communication and frequent updates. Substantive updates are required at least once per month by our <a href="" className="text-[#808191]">Terms of Use</a>. Engaging backers will help establish trust, while a lack of communication may result in backers losing faith, leaving bad feedback, requesting a refund, or even making a credit card chargeback. <a href="" className="text-[#808191]">Learn best practices for customer support.</a></p>
            ...
            <div className="mt-14 px-4 sm:px-6 lg:px-32">
                ...
                <p className="text-justify pb-2">With crowdfunding, there are always risks, so Block Fund does not guarantee that contributions will be used as promised, that campaign owners will deliver perks, or that campaigns will achieve their goals. However, if our <a href="" className="text-[#808191]">Terms of Use</a> are violated, we will take action on behalf of our backers to make things right.</p>
                <p className="text-justify pb-2">Though we don't review crowdfunding campaigns for feasibility, we do require Product Stages for all Tech & Innovation campaigns. Our Trust & Safety team reviews each individual campaign in this category before granting the <a href="" className="text-[#808191]">Prototype Stage, Manufacturing Stage or Shipping Stage to any campaign</a>  - so you can be better informed about where these ideas are in the product lifecycle when you're deciding whether you'd like to back them. If we receive any questions or concerns regarding a particular project, our Trust & Safety experts review and address these concerns with the campaign owners directly.</p>
                ...
                <p className="text-justify pb-2"><a href="" className="font-bold">We are here to support you.</a> You can access our <a href="" className="text-[#808191]">Help Center</a> or <a href="" className="text-[#808191]">Contact Us</a> at any time. Our dedicated Customer Happiness agents will reply to any support query within 24 hours.</p>
            </div>
